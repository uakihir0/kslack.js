(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).p1m = function () {
    return this.o1m_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.o1m_1[index];
  };
  ...
  protoOf(AtomicBoolean).q1m = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).r1m = function () {
  ...
  protoOf(AtomicRef).s1m = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).r1m = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).t1m = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).r1m = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).u1m = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).r1m = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).p1m);
  //endregion
