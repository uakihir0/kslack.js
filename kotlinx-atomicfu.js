(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).a1o = function () {
    return this.z1n_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.z1n_1[index];
  };
  ...
  protoOf(AtomicInt).b1o = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).c1o = function () {
  ...
  protoOf(AtomicBoolean).d1o = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).c1o = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicRef).e1o = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).c1o = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).f1o = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).c1o = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).a1o);
  //endregion
