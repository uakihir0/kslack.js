(function (factory) {
  ...
  var toByteArray_0 = kotlin_kotlin.$_$.e8;
  ...
  function CIOMultipartDataBase(coroutineContext, channel, contentType, contentLength, formFieldLimit) {
    ...
    this.s39_1 = coroutineContext;
    this.t39_1 = null;
    this.u39_1 = parseMultipart(this, channel, contentType, contentLength, formFieldLimit);
  }
  protoOf(CIOMultipartDataBase).m1o = function () {
    return this.s39_1;
  };
  ...
  function thresholdReached($this) {
    return $this.w39_1 >= $this.x39_1 * 0.75;
  }
  function resize($this) {
    var prevSize = $this.w39_1;
    var prevData = $this.y39_1;
    $this.w39_1 = 0;
    $this.x39_1 = imul($this.x39_1, 2) | 128;
    var tmp = $this;
    // Inline function 'kotlin.apply' call
    var this_0 = get_HeadersDataPool().d2m();
    this_0.b3a(imul(prevData.a3a(), 2) | 1);
    tmp.y39_1 = this_0;
    var _iterator__ex2g4s = prevData.c3a().t();
    while (_iterator__ex2g4s.u()) {
      var headerOffset = _iterator__ex2g4s.v();
      $this.e3a(prevData.d3a(headerOffset + 1 | 0), prevData.d3a(headerOffset + 2 | 0), prevData.d3a(headerOffset + 3 | 0), prevData.d3a(headerOffset + 4 | 0));
    }
    get_HeadersDataPool().e2m(prevData);
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.require' call
    if (!(prevSize === $this.w39_1)) {
      var message = 'Failed requirement.';
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
  }
  function headerHasName($this, name, headerOffset) {
    var nameStartIndex = $this.y39_1.d3a(headerOffset + 1 | 0);
    var nameEndIndex = $this.y39_1.d3a(headerOffset + 2 | 0);
    return equalsLowerCase($this.v39_1, nameStartIndex, nameEndIndex, name);
  }
  function HttpHeadersMap(builder) {
    this.v39_1 = builder;
    this.w39_1 = 0;
    this.x39_1 = 0;
    this.y39_1 = get_HeadersDataPool().d2m();
  }
  protoOf(HttpHeadersMap).y1a = function (name) {
    if (this.w39_1 === 0)
      return null;
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(name);
    var hash = abs(this_0);
    var headerIndex = hash % this.x39_1 | 0;
    while (!(this.y39_1.d3a(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.f3a(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.x39_1 | 0;
    }
    return null;
  };
  protoOf(HttpHeadersMap).g3a = function () {
    return this.y39_1.c3a();
  };
  protoOf(HttpHeadersMap).e3a = function (nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.v39_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.v39_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.x39_1 | 0;
    ...
    this.y39_1.o3a(headerOffset + 0 | 0, hash);
    this.y39_1.o3a(headerOffset + 1 | 0, nameStartIndex);
    this.y39_1.o3a(headerOffset + 2 | 0, nameEndIndex);
    this.y39_1.o3a(headerOffset + 3 | 0, valueStartIndex);
    this.y39_1.o3a(headerOffset + 4 | 0, valueEndIndex);
    this.y39_1.o3a(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.y39_1.o3a(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.w39_1 = this.w39_1 + 1 | 0;
  };
  protoOf(HttpHeadersMap).p3a = function (headerOffset) {
    var nameStartIndex = this.y39_1.d3a(headerOffset + 1 | 0);
    var nameEndIndex = this.y39_1.d3a(headerOffset + 2 | 0);
    return this.v39_1.c(nameStartIndex, nameEndIndex);
  };
  protoOf(HttpHeadersMap).f3a = function (headerOffset) {
    var valueStartIndex = this.y39_1.d3a(headerOffset + 3 | 0);
    var valueEndIndex = this.y39_1.d3a(headerOffset + 4 | 0);
    return this.v39_1.c(valueStartIndex, valueEndIndex);
  };
  protoOf(HttpHeadersMap).s18 = function () {
    this.w39_1 = 0;
    this.x39_1 = 0;
    get_HeadersDataPool().e2m(this.y39_1);
    this.y39_1 = get_HeadersDataPool().d2m();
  };
  ...
  protoOf(HeadersData$headersStarts$slambda).e3b = function ($this$sequence, $completion) {
    var tmp = this.f3b($this$sequence, $completion);
    tmp.q8_1 = Unit_instance;
    tmp.r8_1 = null;
    return tmp.w8();
  };
  protoOf(HeadersData$headersStarts$slambda).k9 = function (p1, $completion) {
    return this.e3b(p1 instanceof SequenceScope ? p1 : THROW_CCE(), $completion);
  };
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            this.c3b_1 = this.d3b_1.v();
            this.b3b_1 = 0;
            this.o8_1 = 2;
            continue $sm;
          case 2:
            if (!(this.b3b_1 < this.c3b_1.length)) {
              this.o8_1 = 5;
              continue $sm;
            }

            if (!(this.y3a_1.d3a(this.a3b_1 + 0 | 0) === -1)) {
              this.o8_1 = 3;
              suspendResult = this.z3a_1.ze(this.a3b_1, this);
          ...
          case 3:
            ...
            continue $sm;
          case 4:
            this.b3b_1 = this.b3b_1 + 6 | 0;
            this.a3b_1 = this.a3b_1 + 6 | 0;
            this.o8_1 = 2;
            continue $sm;
          case 5:
            this.o8_1 = 1;
  ...
  protoOf(HeadersData$headersStarts$slambda).f3b = function ($this$sequence, completion) {
    var i = new HeadersData$headersStarts$slambda(this.y3a_1, completion);
    i.z3a_1 = $this$sequence;
    return i;
  };
  function HeadersData$headersStarts$slambda_0(this$0, resultContinuation) {
    ...
    return constructCallableReference(function ($this$sequence, $completion) {
      return i.e3b($this$sequence, $completion);
    }, 1);
  }
  function HeadersData() {
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.z39_1 = ArrayList_init_$Create$();
  }
  protoOf(HeadersData).a3a = function () {
    return this.z39_1.d1();
  };
  protoOf(HeadersData).b3a = function (subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.z39_1.c1(get_IntArrayPool().d2m());
      }
       while (inductionVariable < subArraysCount);
  };
  protoOf(HeadersData).d3a = function (index) {
    return this.z39_1.i1(index / 768 | 0)[index % 768 | 0];
  };
  protoOf(HeadersData).o3a = function (index, value) {
    this.z39_1.i1(index / 768 | 0)[index % 768 | 0] = value;
  };
  protoOf(HeadersData).c3a = function () {
    return sequence(HeadersData$headersStarts$slambda_0(this, null));
  };
  protoOf(HeadersData).s18 = function () {
    var _iterator__ex2g4s = this.z39_1.t();
    while (_iterator__ex2g4s.u()) {
      var array = _iterator__ex2g4s.v();
      get_IntArrayPool().e2m(array);
    }
    this.z39_1.t2();
  };
  function dumpTo(_this__u8e3s4, indent, out) {
    _init_properties_HttpHeadersMap_kt__hwatby();
    var _iterator__ex2g4s = _this__u8e3s4.g3a().t();
    while (_iterator__ex2g4s.u()) {
      var offset = _iterator__ex2g4s.v();
      out.b1(indent);
      out.b1(_this__u8e3s4.p3a(offset));
      out.b1(' => ');
      out.b1(_this__u8e3s4.f3a(offset));
      out.b1('\n');
    }
  }
  ...
  protoOf(IntArrayPool$1).w2l = function () {
    var tmp = 0;
  ...
  protoOf(IntArrayPool$1).j3b = function (instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).b2m.call(this, instance);
  };
  protoOf(IntArrayPool$1).b2m = function (instance) {
    return this.j3b(isIntArray(instance) ? instance : THROW_CCE());
  };
  function HeadersDataPool$1() {
    DefaultPool.call(this, 1000);
  }
  protoOf(HeadersDataPool$1).w2l = function () {
    return new HeadersData();
  };
  protoOf(HeadersDataPool$1).n3b = function (instance) {
    instance.s18();
    return protoOf(DefaultPool).b2m.call(this, instance);
  };
  protoOf(HeadersDataPool$1).b2m = function (instance) {
    return this.n3b(instance instanceof HeadersData ? instance : THROW_CCE());
  };
  ...
  function parseHeaderName(text, range) {
    _init_properties_HttpParser_kt__gbdom1();
    var index = range.b3c_1;
    var end = range.c3c_1;
    while (index < end) {
      var ch = text.b(index);
      if (ch === _Char___init__impl__6a9atx(58) && !(index === range.b3c_1)) {
        range.b3c_1 = index + 1 | 0;
        return index;
      }
      if (isDelimiter(ch)) {
        parseHeaderNameFailed(text, index, range.b3c_1, ch);
      }
      index = index + 1 | 0;
    }
  ...
  function parseHeaderValue(text, range) {
    ...
    range.b3c_1 = valueStart;
    range.c3c_1 = valueLastIndex + 1 | 0;
  }
  ...
  function noColonFound(text, range) {
    _init_properties_HttpParser_kt__gbdom1();
    var tmp2 = range.b3c_1;
    // Inline function 'kotlin.text.substring' call
    var endIndex = range.c3c_1;
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.p8_1 = 7;
            this.z3b_1 = new HttpHeadersMap(this.x3b_1);
            this.p8_1 = 6;
            this.o8_1 = 1;
            continue $sm;
          case 1:
            ...
            this.o8_1 = 2;
            suspendResult = readLineStrictTo(this.w3b_1, this.x3b_1, 8192n, VOID, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 3:
            this.y3b_1.c3c_1 = this.x3b_1.n3a_1;
            this.a3c_1 = this.y3b_1.c3c_1 - this.y3b_1.b3c_1 | 0;
            if (this.a3c_1 === 0) {
              this.o8_1 = 5;
              continue $sm;
            } else {
          ...
          case 4:
            ...
            var nameStart = this.y3b_1.b3c_1;
            var nameEnd = parseHeaderName(this.x3b_1, this.y3b_1);
            var headerEnd = this.y3b_1.c3c_1;
            parseHeaderValue(this.x3b_1, this.y3b_1);
            var valueStart = this.y3b_1.b3c_1;
            var valueEnd = this.y3b_1.c3c_1;
            this.y3b_1.b3c_1 = headerEnd;
            this.z3b_1.e3a(nameStart, nameEnd, valueStart, valueEnd);
            this.o8_1 = 1;
            continue $sm;
          case 5:
            var host = this.z3b_1.y1a('Host');
            if (!(host == null)) {
  ...
  function _init_properties_HttpParser_kt__gbdom1() {
    if (!properties_initialized_HttpParser_kt_uedryv) {
      ...
      httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance().i2l_1, Companion_getInstance().h2l_1);
      versions = Companion_instance.d3c(listOf(['HTTP/1.0', 'HTTP/1.1']));
    }
  }
  function get_CrLf() {
  ...
  function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
    ...
    _init_properties_Multipart_kt__ato98a();
    if (!MultiPart_getInstance().j2w(contentType)) {
  ...
  function parseMultipart$slambda$slambda($firstBoundary, $countedInput, resultContinuation) {
    this.b3e_1 = $firstBoundary;
    this.c3e_1 = $countedInput;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(parseMultipart$slambda$slambda).e3e = function ($this$writer, $completion) {
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.p8_1 = 3;
            this.o8_1 = 1;
            suspendResult = parsePreambleImpl(this.b3e_1, this.c3e_1, this.d3e_1.k2j_1, 8193n, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            this.o8_1 = 2;
            suspendResult = this.d3e_1.k2j_1.q2b(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(parseMultipart$slambda$slambda).f3e = function ($this$writer, completion) {
    var i = new parseMultipart$slambda$slambda(this.b3e_1, this.c3e_1, completion);
    i.d3e_1 = $this$writer;
    return i;
  };
  ...
  function parseMultipart$slambda($input, $boundaryPrefixed, $maxPartSize, $totalLength, resultContinuation) {
    ...
    this.q3e_1 = $maxPartSize;
    this.r3e_1 = $totalLength;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(parseMultipart$slambda).a3f = function ($this$produce, $completion) {
    var tmp = this.b3f($this$produce, $completion);
    tmp.q8_1 = Unit_instance;
    tmp.r8_1 = null;
    return tmp.w8();
  };
  protoOf(parseMultipart$slambda).k9 = function (p1, $completion) {
    return this.a3f((!(p1 == null) ? isInterface(p1, ProducerScope) : false) ? p1 : THROW_CCE(), $completion);
  };
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.p8_1 = 25;
            this.t3e_1 = counted(this.o3e_1);
            this.u3e_1 = this.t3e_1.f2l();
            this.y3e_1 = this.p3e_1.t1k(get_PrefixString().d1());
            this.o8_1 = 1;
            suspendResult = readRemaining(writer(this.s3e_1, VOID, VOID, parseMultipart$slambda$slambda_0(this.y3e_1, this.t3e_1, null)).j2d_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            ...
            if (get_remaining(preambleData) > 0n) {
              this.o8_1 = 2;
              suspendResult = this.s3e_1.k25(new Preamble(preambleData), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 4:
            if (!this.t3e_1.n2b()) {
              this.o8_1 = 5;
              suspendResult = skipIfFound(this.t3e_1, get_PrefixString(), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 6:
            ...
            this.o8_1 = 7;
            suspendResult = skipIfFound(this.t3e_1, get_CrLf(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 7:
            this.o8_1 = 8;
            suspendResult = skipIfFound(this.t3e_1, this.y3e_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 9:
            this.v3e_1 = new ByteChannel();
            this.x3e_1 = CompletableDeferred();
            var part = new MultipartPart(this.x3e_1, this.v3e_1);
            this.o8_1 = 10;
            suspendResult = this.s3e_1.k25(part, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 10:
            ...
            this.p8_1 = 14;
            this.o8_1 = 11;
            suspendResult = parsePartHeadersImpl(this.t3e_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 11:
            ...
            if (!this.x3e_1.c1v(this.w3e_1)) {
              this.w3e_1.s18();
              throw CancellationException_init_$Create$('Multipart processing has been cancelled');
            }

            this.o8_1 = 12;
            suspendResult = parsePartBodyImpl(this.p3e_1, this.t3e_1, this.v3e_1, this.w3e_1, this.q3e_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 14:
            ...
            if (tmp_0 instanceof Error) {
              var cause = this.r8_1;
              if (this.x3e_1.d1v(cause)) {
                var tmp0_safe_receiver = this.w3e_1;
                if (tmp0_safe_receiver == null)
                  null;
                else {
                  tmp0_safe_receiver.s18();
                }
              }
              close(this.v3e_1, cause);
              throw cause;
            } else {
              throw this.r8_1;
            }
          ...
          case 17:
            if (!(this.r3e_1 == null)) {
              var consumedExceptEpilogue = subtract(this.t3e_1.f2l(), this.u3e_1);
              var size = subtract(this.r3e_1, consumedExceptEpilogue);
              if (size > 2147483647n)
                throw IOException_init_$Create$('Failed to parse multipart: prologue is too long');
              if (size > 0n) {
                this.o8_1 = 21;
                suspendResult = readPacket(this.t3e_1, convertToInt(size), this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
              ...
              this.o8_1 = 18;
              suspendResult = readRemaining(this.t3e_1, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 18:
            ...
            if (!epilogueContent.b1l()) {
              this.o8_1 = 19;
              suspendResult = this.s3e_1.k25(new Epilogue(epilogueContent), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 21:
            ...
            this.o8_1 = 22;
            suspendResult = this.s3e_1.k25(ARGUMENT_0, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(parseMultipart$slambda).b3f = function ($this$produce, completion) {
    var i = new parseMultipart$slambda(this.o3e_1, this.p3e_1, this.q3e_1, this.r3e_1, completion);
    i.s3e_1 = $this$produce;
    return i;
  };
  function parseMultipart$slambda_0($input, $boundaryPrefixed, $maxPartSize, $totalLength, resultContinuation) {
    ...
    return constructCallableReference(function ($this$produce, $completion) {
      return i.a3f($this$produce, $completion);
    }, 1);
  }
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.p8_1 = 3;
            this.r3c_1 = new CharArrayBuilder();
            this.p8_1 = 2;
            this.o8_1 = 1;
            suspendResult = parseHeaders(this.q3c_1, this.r3c_1, VOID, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.p8_1 = 6;
            var tmp0_safe_receiver = this.d3d_1.y1a('Content-Length');
            var contentLength = tmp0_safe_receiver == null ? null : parseDecLong(tmp0_safe_receiver);
            if (contentLength == null) {
              this.o8_1 = 3;
              suspendResult = readUntil(this.b3d_1, this.a3d_1, this.c3d_1, this.e3d_1, true, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
            } else {
              var containsUpper = this.e3d_1;
              if (0n <= contentLength ? contentLength <= containsUpper : false) {
                this.o8_1 = 1;
                suspendResult = copyTo(this.b3d_1, this.c3d_1, contentLength, this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
                ...
                var tmp_0 = this;
                throwLimitExceeded(contentLength, this.e3d_1);
              }
            }
          ...
          case 1:
            ...
            this.o8_1 = 2;
            suspendResult = skipIfFoundReadCount(this.b3d_1, this.a3d_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 2:
            var ARGUMENT = suspendResult;
            this.g3d_1 = add(this.h3d_1, ARGUMENT);
            this.o8_1 = 4;
            continue $sm;
          case 3:
            ...
            continue $sm;
          case 4:
            this.f3d_1 = this.g3d_1;
            this.o8_1 = 5;
            suspendResult = this.c3d_1.h2b(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.p8_1 = 3;
            this.o8_1 = 1;
            suspendResult = skipIfFound(this.q3d_1, this.r3d_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            if (suspendResult) {
              var tmp_0 = this;
              tmp_0.s3d_1 = fromInt(this.r3d_1.d1());
              this.o8_1 = 2;
              continue $sm;
            } else {
              var tmp_1 = this;
  ...
  protoOf(Companion).d3c = function (from) {
    var tmp = AsciiCharTree$Companion$build$lambda;
    return this.g3f(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  };
  protoOf(Companion).g3f = function (from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
  ...
  function getImpl($this, index) {
    return bufferForIndex($this, index)[index % ensureNotNull($this.j3a_1).length | 0];
  }
  ...
  protoOf(SubSequenceImpl).a = function () {
    return this.j3f_1 - this.i3f_1 | 0;
  };
  protoOf(SubSequenceImpl).b = function (index) {
    var withOffset = index + this.i3f_1 | 0;
    // Inline function 'kotlin.require' call
    if (!(index >= 0)) {
  ...
  protoOf(SubSequenceImpl).c = function (startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.j3f_1 - this.i3f_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.l3f_1, this.i3f_1 + startIndex | 0, this.i3f_1 + endIndex | 0);
  };
  protoOf(SubSequenceImpl).toString = function () {
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      var this_0 = toString(copy(this.l3f_1, this.i3f_1, this.j3f_1));
      this.k3f_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  protoOf(SubSequenceImpl).equals = function (other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.l3f_1, this.i3f_1, other, 0, this.a());
  };
  protoOf(SubSequenceImpl).hashCode = function () {
    var tmp0_safe_receiver = this.k3f_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.l3f_1, this.i3f_1, this.j3f_1) : tmp1_elvis_lhs;
  };
  function bufferForIndex($this, index) {
    ...
    return list.i1(index / ensureNotNull($this.j3a_1).length | 0);
  }
  ...
  function nonFullBuffer($this) {
    return $this.m3a_1 === 0 ? appendNewArray($this) : ensureNotNull($this.j3a_1);
  }
  function appendNewArray($this) {
    var newBuffer = $this.h3a_1.d2m();
    var existing = $this.j3a_1;
    $this.j3a_1 = newBuffer;
    $this.m3a_1 = newBuffer.length;
    $this.l3a_1 = false;
    if (!(existing == null)) {
  ...
  function currentPosition($this) {
    return ensureNotNull($this.j3a_1).length - $this.m3a_1 | 0;
  }
  ...
  protoOf(CharArrayBuilder).b = function (index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.n3a_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.n3a_1 + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_0));
    }
  ...
  protoOf(CharArrayBuilder).c = function (startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.n3a_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.n3a_1 + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_1));
    }
  ...
  protoOf(CharArrayBuilder).toString = function () {
    ...
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.n3a_1));
      this.k3a_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  protoOf(CharArrayBuilder).equals = function (other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.n3a_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.n3a_1);
  };
  protoOf(CharArrayBuilder).hashCode = function () {
    var tmp0_safe_receiver = this.k3a_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.n3a_1) : tmp1_elvis_lhs;
  };
  protoOf(CharArrayBuilder).s = function (value) {
    nonFullBuffer(this)[ensureNotNull(this.j3a_1).length - this.m3a_1 | 0] = value;
    this.k3a_1 = null;
    this.m3a_1 = this.m3a_1 - 1 | 0;
    this.n3a_1 = this.n3a_1 + 1 | 0;
    return this;
  };
  protoOf(CharArrayBuilder).fc = function (value, startIndex, endIndex) {
    if (value == null)
      return this;
    var current = startIndex;
    while (current < endIndex) {
      var buffer = nonFullBuffer(this);
      var offset = buffer.length - this.m3a_1 | 0;
      ...
      this.m3a_1 = this.m3a_1 - bytesToCopy | 0;
    }
    this.k3a_1 = null;
    this.n3a_1 = this.n3a_1 + (endIndex - startIndex | 0) | 0;
    return this;
  };
  protoOf(CharArrayBuilder).b1 = function (value) {
    if (value == null)
      return this;
    return this.fc(value, 0, charSequenceLength(value));
  };
  protoOf(CharArrayBuilder).s18 = function () {
    var list = this.i3a_1;
    if (!(list == null)) {
      this.j3a_1 = null;
      var inductionVariable = 0;
      ...
      if (tmp0_safe_receiver == null)
        ...
        // Inline function 'kotlin.let' call
        this.h3a_1.e2m(tmp0_safe_receiver);
      }
      this.j3a_1 = null;
    }
    this.l3a_1 = true;
  ...
  protoOf(CharArrayPool$1).d2m = function () {
    return charArray(2048);
  };
  function CharArrayPool$2() {
    DefaultPool.call(this, 4096);
  }
  protoOf(CharArrayPool$2).w2l = function () {
    return charArray(2048);
  };
  ...
  function DefaultHttpMethods$lambda(it) {
    _init_properties_Chars_kt__d3i39x();
    return it.a32_1.length;
  }
  function DefaultHttpMethods$lambda_0(m, idx) {
    _init_properties_Chars_kt__d3i39x();
    return new Char(charCodeAt(m.a32_1, idx));
  }
  ...
  function _init_properties_Chars_kt__d3i39x() {
    if (!properties_initialized_Chars_kt_phjfhp) {
      ...
      var tmp_0 = Companion_getInstance_0().z31_1;
      var tmp_1 = DefaultHttpMethods$lambda;
      DefaultHttpMethods = tmp.g3f(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);
  ...
  protoOf(MutableRange).toString = function () {
    return 'MutableRange(start=' + this.b3c_1 + ', end=' + this.c3c_1 + ')';
  };
