(function (factory) {
  ...
  var toCharArray = kotlin_kotlin.$_$.ce;
  ...
  protoOf(ByteString).q1i = function (startIndex, endIndex) {
    var tmp;
  ...
  protoOf(ByteString).i1j = function (startIndex, endIndex, $super) {
    endIndex = endIndex === VOID ? this.d1() : endIndex;
    return $super === VOID ? this.q1i(startIndex, endIndex) : $super.q1i.call(this, startIndex, endIndex);
  };
  protoOf(ByteString).j1j = function (other) {
    if (other === this)
      return 0;
  ...
  protoOf(ByteString).d = function (other) {
    return this.j1j(other instanceof ByteString ? other : THROW_CCE());
  };
  protoOf(ByteString).toString = function () {
    ...
    if (inductionVariable < last)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        var b = localData[i];
        $this$with.s(Companion_getInstance().e1j_1[(b >>> 4 | 0) & 15]);
        $this$with.s(Companion_getInstance().e1j_1[b & 15]);
      }
       while (inductionVariable < last);
    return $this$with.s(_Char___init__impl__6a9atx(41)).toString();
  };
  protoOf(ByteString).k1j = function () {
    return this.g1j_1;
  };
  ...
  function decodeToString_0(_this__u8e3s4) {
    return decodeToString(_this__u8e3s4.k1j());
  }
  ...
  protoOf(UnsafeByteStringOperations).l1j = function (array) {
